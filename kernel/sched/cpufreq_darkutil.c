...
static int dugov_init(struct cpufreq_policy *policy)
{
	...
	tunables->silver_suspend_max_freq = DEFAULT_SILVER_SUSPEND_MAX_FREQ;
	tunables->gold_suspend_max_freq = DEFAULT_GOLD_SUSPEND_MAX_FREQ;
